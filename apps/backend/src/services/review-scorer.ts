...
export function computeScore(review: AIReviewResult, semanticDiff: SemanticDiff): ReviewScore {
...
export function computeTrend(currentScore: number, recentScores: number[]): number | null {
